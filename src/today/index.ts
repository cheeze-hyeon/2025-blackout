...
//     view: {
//       type: 'modal',
//       callback_id: 'TodayConversation_info_modal',
//       title: {
//         type: 'plain_text',
//         text: '환영합니다!',
//       },
...
export const registerTodayConversationEvents = async () => {
  ...
  //       channel: channel,
  //       text: 'TodayConversation to Globee!',
  //       blocks: [
  //         {
  //           type: 'section',
  //           text: {
  ...
  //                 text: '정보 입력하기',
  //               },
  //               action_id: 'TodayConversation_provide_info',
  //               style: 'primary',
  //             },
  //           ],
  //         },
  ...
  //   'TodayConversation_provide_info',
